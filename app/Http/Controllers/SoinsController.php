...
class SoinsController extends Controller
{
    ...
    {
         $this->middleware('permission:index-soins|create-soins|edit-soins|delete-soins', ['only' => ['index','store']]);
         $this->middleware('permission:create-soins', ['only' => ['create','store']]);
         $this->middleware('permission:edit-soins', ['only' => ['edit','update']]);
         $this->middleware('permission:delete-soins', ['only' => ['destroy']]);
    }
