...
class InterventionController extends Controller
{
    ...
    {
         $this->middleware('permission:index-intervention|create-intervention|edit-intervention|delete-intervention', ['only' => ['index','store']]);
         $this->middleware('permission:create-intervention', ['only' => ['create','store']]);
         $this->middleware('permission:edit-intervention', ['only' => ['edit','update']]);
         $this->middleware('permission:delete-intervention', ['only' => ['destroy']]);
    }
