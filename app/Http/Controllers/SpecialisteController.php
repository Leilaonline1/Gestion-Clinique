...
class SpecialisteController extends Controller
{
    ...
    {
         $this->middleware('permission:index-specialiste|create-specialiste|edit-specialiste|delete-specialiste', ['only' => ['index','store']]);
         $this->middleware('permission:create-specialiste', ['only' => ['create','store']]);
         $this->middleware('permission:edit-specialiste', ['only' => ['edit','update']]);
         $this->middleware('permission:delete-specialiste', ['only' => ['destroy']]);
    }
