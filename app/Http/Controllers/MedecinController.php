...
class MedecinController extends Controller
{
     ...
     */
     ...
     {
          $this->middleware('permission:index-medecin|create-medecin|edit-medecin|delete-medecin', ['only' => ['index','store']]);
          $this->middleware('permission:create-medecin', ['only' => ['create','store']]);
          $this->middleware('permission:edit-medecin', ['only' => ['edit','update']]);
          $this->middleware('permission:delete-medecin', ['only' => ['destroy']]);
     }
