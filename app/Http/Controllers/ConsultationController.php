...
class ConsultationController extends Controller
{
    ...
    {
         $this->middleware('permission:index-consultation|create-consultation|edit-consultation|delete-consultation', ['only' => ['index','store']]);
         $this->middleware('permission:create-consultation', ['only' => ['create','store']]);
         $this->middleware('permission:edit-consultation', ['only' => ['edit','update']]);
         $this->middleware('permission:delete-consultation', ['only' => ['destroy']]);
    }
