...
class ExamenController extends Controller
{
    ...
    {
         $this->middleware('permission:index-examen|create-examen|edit-examen|delete-examen', ['only' => ['index','store']]);
         $this->middleware('permission:create-examen', ['only' => ['create','store']]);
         $this->middleware('permission:edit-examen', ['only' => ['edit','update']]);
         $this->middleware('permission:delete-examen', ['only' => ['destroy']]);
    }
